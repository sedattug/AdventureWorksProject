...
xajax.js.includeScript = function (command) {
    ...
    if ('undefined' == typeof command.type)
        objScript.type = 'text/javascript';
    else
        objScript.type = command.type;
    if ('undefined' != typeof command.type)
...
xajax.processParameters = function (oRequest) {
    ...
    var csrf = xajax.config.ci_default_token;
...
if ('undefined' == typeof JSON)
    xajax.js.includeScript({data: xajax.config.JavaScriptURI + 'xajax_js/JSON.js'});