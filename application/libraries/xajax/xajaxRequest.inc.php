...
class xajaxRequest {
    ...
    public function addParameter() {
        ...
        if (1 < count($aArgs)) {
            $this->setParameter(
                    count($this->aParameters), $aArgs[0], $aArgs[1]);
        }
    }
    ...
    public function setParameter() {
        ...
        if (2 < count($aArgs)) {
            ...
            if (XAJAX_FORM_VALUES === $sType) {
                $sFormID = $aArgs[2];
                $this->aParameters[$nParameter] = "xajax.getFormValues("
                        . $this->sQuoteCharacter
                        . $sFormID
                        . $this->sQuoteCharacter
                        . ")";
                ...
                $sInputID = $aArgs[2];
                $this->aParameters[$nParameter] = "xajax.$("
                        . $this->sQuoteCharacter
                        . $sInputID
                        . $this->sQuoteCharacter
                        . ").value";
                ...
                $sValue = $aArgs[2];
                $this->aParameters[$nParameter] = $this->sQuoteCharacter
                        . $sValue
                        . $this->sQuoteCharacter;
