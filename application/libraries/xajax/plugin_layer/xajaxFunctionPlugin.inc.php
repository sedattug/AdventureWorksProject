...
class xajaxFunctionPlugin extends xajaxRequestPlugin {
    ...
    function __construct() {
        ...
        if ($this->ci->input->get('xjxfun', true) !== null) {
            $this->sRequestedFunction = $this->ci->input->get('xjxfun', true);
        }
        if ($this->ci->input->post('xjxfun', true) !== null) {
            $this->sRequestedFunction = $this->ci->input->post('xjxfun', true);
        }
    }
