...
class xajaxScriptPlugin extends xajaxRequestPlugin {
    ...
    function __construct() {
        ...
        if ($this->ci->input->get('xjxGenerateJavascript', true) !== null) {
            $this->sRequest = 'script';
            $this->sHash = $this->ci->input->get('xjxGenerateJavascript', true);
        }

        if ($this->ci->input->get('xjxGenerateStyle', true) !== null) {
            $this->sRequest = 'style';
            $this->sHash = $this->ci->input->get('xjxGenerateStyle', true);
        }
    }
...
//				echo "<!--" . print_r($aScripts, true) . "-->";
                ...
                echo "\n<script src='" . $this->sRequestURI . $sQuery . "'></script>\n";
            }
