...
final class xajaxIncludeClientScriptPlugin extends xajaxRequestPlugin {
    ...
    public function printJavascriptConfig() {
        ...
        echo '";';
        echo $sCrLf;
        echo 'xajax.config.ci_default_token = "';
        echo $this->ci->security->get_csrf_hash();
        echo '";';        
    ...
    public function printJavascriptInclude() {
        ...
        if (0 === count($aJsFiles)) {
            $aJsFiles[] = array($this->_getScriptFilename('xajax_js/xajax_core.js'), 'xajax'); //('xajax_js/xajax_core.js'), 'xajax');
