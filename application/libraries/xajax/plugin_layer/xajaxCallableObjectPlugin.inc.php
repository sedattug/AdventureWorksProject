...
final class xajaxCallableObjectPlugin extends xajaxRequestPlugin {
    ...
    public function __construct() {
        ...
        if (!empty($this->ci->input->get('xjxcls', true))) {
            $this->sRequestedClass = $this->ci->input->get('xjxcls', true);
        }
        if (!empty($this->ci->input->get('xjxmthd', true))) {
            $this->sRequestedMethod = $this->ci->input->get('xjxmthd', true);
        }
        if (!empty($this->ci->input->post('xjxcls', true))) {
            $this->sRequestedClass = $this->ci->input->post('xjxcls', true);
        }
        if (!empty($this->ci->input->post('xjxmthd', true))) {
            $this->sRequestedMethod = $this->ci->input->post('xjxmthd', true);
        }
    }
